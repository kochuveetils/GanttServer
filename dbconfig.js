...
module.exports = {
    user: process.env.NODE_ORACLEDB_USER || "acdba",
    ...
    // needed.
    password: process.env.NODE_ORACLEDB_PASSWORD || "acdba",

    // For information on connection strings see:
    // https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
    // connectString: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "sacprddbprimary.virginaustralia.internal/SACPRD_ONLINE_PRIMARY",
    connectString: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "ldrsacdbtst01.virginaustralia.internal/SACCRT_ONLINE_PRIMARY",
    // connectString: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "192.168.0.64/skdb11",
